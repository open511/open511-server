...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for rdev in orm.RoadEvent.objects.all():
            if '<road_name' in rdev.xml_data:
                rdev.xml_data = rdev.xml_data.replace('<road_name', '<name').replace('</road_name', '</name')
                rdev.save()
    ...
    models = {
        ...
        u'open511.area': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 12, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 12, 0, 0)'}),
