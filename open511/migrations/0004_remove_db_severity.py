...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RoadEvent.severity'
        db.delete_column(u'open511_roadevent', 'severity')


    def backwards(self, orm):
        # Adding field 'RoadEvent.severity'
        db.add_column(u'open511_roadevent', 'severity',
