...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoadEvent.published'
        db.add_column(u'open511_roadevent', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoadEvent.published'
        db.delete_column(u'open511_roadevent', 'published')
