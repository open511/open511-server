...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('open511_jurisdiction', 'id', 'internal_id');
        db.rename_column('open511_jurisdiction', 'slug', 'id');

    def backwards(self, orm):

        db.rename_column('open511_jurisdiction', 'internal_id', 'id');
        db.rename_column('open511_jurisdiction', 'id', 'slug');
    ...
    models = {
        ...
        u'open511.area': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 17, 0, 0)'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 17, 0, 0)'}),
